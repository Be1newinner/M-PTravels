  ...
  return (
    <div>
      <div className="flex relative">
        <div className="w-6/12 border max-lg:mx-auto py-16 px-16 gap-0 max-xl:px-4 max-sm:w-11/12 max-xl:py-4 max-lg:w-3/5 max-md:w-2/3 max-lg:rounded-xl max-lg:0 max-lg:z-50 text-center max-2xl:py-2 max-2xl:px-4 max-lg:bg-white ">
          <Link
            to="/"
            className="text-blue-600 text-sm font-medium flex items-center py-4 max-md:py-2"
          >
            <IoIosArrowBack />
            Back To Home
          </Link>
          <h1 className="text-4xl font-medium py-2 max-lg:text-start max-md:py-0 max-lg:text-3xl">Create an account</h1>
          <div className="py-6 max-lg:py-4">
            <Link
          ...
          <form className="flex flex-wrap">
            <div className="w-1/2 max-sm:w-full max-sm:pr-0 pr-4 py-6 max-sm:py-2 max-xl:py-4 rounded-2xl">
              <input
                type="text"
                name="name"
            ...
            <div className="w-1/2 max-sm:w-full max-sm:pl-0 mt-6 pl-4 h-12">
            <select className="w-full h-full pr-4 outline-none bg-slate-200 px-4 text-black rounded">
            ...
            <div className="w-full flex justify-end py-6 max-md:py-2">
              <input
                type="submit"
        ...
        <div className=" bg-black max-lg:absolute ">
          <img src="/login.jpg" alt="login" className="object-cover max-md:h-screen h-full w-screen"></img>
        </div>
      </div>
    </div>
  );
