    ...
    return (
      <div>
        ...
        <div className="flex justify-between items-center bg-slate-50">
          <img src="/images/vacation.png" alt="vacation" className="h-72 max-sm:h-20 max-md:h-32 max-lg:h-48 max-sm:mt-6 p-8 max-sm:p-1 max-md:p-3" />
          <h1 className="text-center pl-8 max-lg:pl-0 text-5xl max-sm:text-2xl font-bold w-1/3">
            Privacy Policy
          </h1>
          <img src="/images/location.png" alt="plan" className="w-1/4 max-sm:w-1/4 max-sm: bg-slate-200" />
        </div>
      </div>
      </div>
    );
