  ...
  return (
    <footer className="flex justify-between max-md:justify-between max-lg:justify-normal max-md:gap-0 max-lg:gap-10 bg-white px-20 py-10 max-xl:flex-wrap max-sm:px-4 max-xl:px-8 ">
      ...
      <div>
        ...
        <ul className="text-sm">
          <li className="pt-4 py-4">
            <Link href="/trip_booking">Book Trip</Link>
          </li>
          <li>
            <Link href="/tour_package">Travel Services</Link>
          </li>
          <li className="py-4">
            <Link href="/">Transportation</Link>
          </li>
          <li>
            <Link href="/tour_package">Planning Your Trip</Link>
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul className="text-sm">
          ...
          <li>
            <Link href="/news_listing">Blogs</Link>
          </li>
          <li className="py-4">
      ...
      <div>
        ...
        <ul className="text-sm">
          <li className="pt-4 py-4">
            <Link href="/trip_booking">Check-in</Link>
          </li>
          <li>
            <Link href="/tour_package">Manage Your Booking</Link>
          </li>
          <li className="py-4">
